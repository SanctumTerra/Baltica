import { Connection, Logger, Server as RaknetServer } from "@sanctumterra/raknet";
import { Emitter } from "../libs";
import { defaultServerOptions, ServerEvents, ServerOptions } from "./types";
        ...
        this.raknet.on("connect", (connection) => {
            ...
            if(existingPlayer) {
                try {
	    			...
	    			disconnectPacket.message = new DisconnectMessage("New connection has been created with the same Address..", );
